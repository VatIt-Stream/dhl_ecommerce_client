...
# Unit tests for DhlEcommerceClient::ItemQuantity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemQuantity' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ItemQuantity.new
  end
  ...
  describe 'test an instance of ItemQuantity' do
    it 'should create an instance of ItemQuantity' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ItemQuantity)
    end
  end
