...
# Unit tests for DhlEcommerceClient::ConsigneeAddress3
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConsigneeAddress3' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ConsigneeAddress3.new
  end
  ...
  describe 'test an instance of ConsigneeAddress3' do
    it 'should create an instance of ConsigneeAddress3' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ConsigneeAddress3)
    end
  end
