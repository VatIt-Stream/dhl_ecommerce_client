...
# Unit tests for DhlEcommerceClient::ItemValue
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemValue' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ItemValue.new
  end
  ...
  describe 'test an instance of ItemValue' do
    it 'should create an instance of ItemValue' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ItemValue)
    end
  end
