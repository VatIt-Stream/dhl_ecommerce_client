...
# Unit tests for DhlEcommerceClient::LabelDetail1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'LabelDetail1' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::LabelDetail1.new
  end
  ...
  describe 'test an instance of LabelDetail1' do
    it 'should create an instance of LabelDetail1' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::LabelDetail1)
    end
  end
