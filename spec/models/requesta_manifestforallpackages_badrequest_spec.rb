...
# Unit tests for DhlEcommerceClient::RequestaManifestforallpackagesBadrequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestaManifestforallpackagesBadrequest' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::RequestaManifestforallpackagesBadrequest.new
  end
  ...
  describe 'test an instance of RequestaManifestforallpackagesBadrequest' do
    it 'should create an instance of RequestaManifestforallpackagesBadrequest' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::RequestaManifestforallpackagesBadrequest)
    end
  end
