...
# Unit tests for DhlEcommerceClient::CreateInternationalLabelRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateInternationalLabelRequest' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::CreateInternationalLabelRequest.new
  end
  ...
  describe 'test an instance of CreateInternationalLabelRequest' do
    it 'should create an instance of CreateInternationalLabelRequest' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::CreateInternationalLabelRequest)
    end
  end
  ...
  describe 'test attribute "ordered_product_id"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "shipper_address"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
