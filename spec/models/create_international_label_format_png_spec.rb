...
# Unit tests for DhlEcommerceClient::CreateInternationalLabelFormatPNG
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateInternationalLabelFormatPNG' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::CreateInternationalLabelFormatPNG.new
  end
  ...
  describe 'test an instance of CreateInternationalLabelFormatPNG' do
    it 'should create an instance of CreateInternationalLabelFormatPNG' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::CreateInternationalLabelFormatPNG)
    end
  end
