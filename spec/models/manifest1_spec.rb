...
# Unit tests for DhlEcommerceClient::Manifest1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Manifest1' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::Manifest1.new
  end
  ...
  describe 'test an instance of Manifest1' do
    it 'should create an instance of Manifest1' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::Manifest1)
    end
  end
  ...
  describe 'test attribute "manifest_data"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
