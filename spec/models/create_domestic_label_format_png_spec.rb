...
# Unit tests for DhlEcommerceClient::CreateDomesticLabelFormatPNG
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateDomesticLabelFormatPNG' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::CreateDomesticLabelFormatPNG.new
  end
  ...
  describe 'test an instance of CreateDomesticLabelFormatPNG' do
    it 'should create an instance of CreateDomesticLabelFormatPNG' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::CreateDomesticLabelFormatPNG)
    end
  end
