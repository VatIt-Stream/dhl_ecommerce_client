...
# Unit tests for DhlEcommerceClient::TrackPackagesusingmultipleParameters
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackPackagesusingmultipleParameters' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::TrackPackagesusingmultipleParameters.new
  end
  ...
  describe 'test an instance of TrackPackagesusingmultipleParameters' do
    it 'should create an instance of TrackPackagesusingmultipleParameters' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::TrackPackagesusingmultipleParameters)
    end
  end
