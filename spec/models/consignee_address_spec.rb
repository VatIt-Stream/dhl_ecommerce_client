...
# Unit tests for DhlEcommerceClient::ConsigneeAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConsigneeAddress' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ConsigneeAddress.new
  end
  ...
  describe 'test an instance of ConsigneeAddress' do
    it 'should create an instance of ConsigneeAddress' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ConsigneeAddress)
    end
  end
