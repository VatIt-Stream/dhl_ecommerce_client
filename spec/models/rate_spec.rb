...
# Unit tests for DhlEcommerceClient::Rate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Rate' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::Rate.new
  end
  ...
  describe 'test an instance of Rate' do
    it 'should create an instance of Rate' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::Rate)
    end
  end
  ...
  describe 'test attribute "rate_date"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
