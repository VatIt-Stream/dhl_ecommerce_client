...
# Unit tests for DhlEcommerceClient::EstimatedDeliveryDate
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'EstimatedDeliveryDate' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::EstimatedDeliveryDate.new
  end
  ...
  describe 'test an instance of EstimatedDeliveryDate' do
    it 'should create an instance of EstimatedDeliveryDate' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::EstimatedDeliveryDate)
    end
  end
  describe 'test attribute "calculate"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "delivery_by"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "expected_transit"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
