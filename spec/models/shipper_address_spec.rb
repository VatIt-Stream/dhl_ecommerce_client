...
# Unit tests for DhlEcommerceClient::ShipperAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShipperAddress' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ShipperAddress.new
  end
  ...
  describe 'test an instance of ShipperAddress' do
    it 'should create an instance of ShipperAddress' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ShipperAddress)
    end
  end
