...
# Unit tests for DhlEcommerceClient::CreateDomesticLabelRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateDomesticLabelRequest' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::CreateDomesticLabelRequest.new
  end
  ...
  describe 'test an instance of CreateDomesticLabelRequest' do
    it 'should create an instance of CreateDomesticLabelRequest' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::CreateDomesticLabelRequest)
    end
  end
