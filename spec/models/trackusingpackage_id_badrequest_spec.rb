...
# Unit tests for DhlEcommerceClient::TrackusingpackageIdBadrequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackusingpackageIdBadrequest' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::TrackusingpackageIdBadrequest.new
  end
  ...
  describe 'test an instance of TrackusingpackageIdBadrequest' do
    it 'should create an instance of TrackusingpackageIdBadrequest' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::TrackusingpackageIdBadrequest)
    end
  end
