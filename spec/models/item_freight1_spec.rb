...
# Unit tests for DhlEcommerceClient::ItemFreight1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemFreight1' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ItemFreight1.new
  end
  ...
  describe 'test an instance of ItemFreight1' do
    it 'should create an instance of ItemFreight1' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ItemFreight1)
    end
  end
