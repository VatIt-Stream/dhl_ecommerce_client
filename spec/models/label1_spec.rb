...
# Unit tests for DhlEcommerceClient::Label1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Label1' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::Label1.new
  end
  ...
  describe 'test an instance of Label1' do
    it 'should create an instance of Label1' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::Label1)
    end
  end
  ...
  describe 'test attribute "label_detail"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
