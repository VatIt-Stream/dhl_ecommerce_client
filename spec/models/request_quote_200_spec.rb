...
# Unit tests for DhlEcommerceClient::RequestQuote200
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestQuote200' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::RequestQuote200.new
  end
  ...
  describe 'test an instance of RequestQuote200' do
    it 'should create an instance of RequestQuote200' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::RequestQuote200)
    end
  end
  ...
  describe 'test attribute "fee_totals"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
