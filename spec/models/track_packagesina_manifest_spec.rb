...
# Unit tests for DhlEcommerceClient::TrackPackagesinaManifest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackPackagesinaManifest' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::TrackPackagesinaManifest.new
  end
  ...
  describe 'test an instance of TrackPackagesinaManifest' do
    it 'should create an instance of TrackPackagesinaManifest' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::TrackPackagesinaManifest)
    end
  end
