...
# Unit tests for DhlEcommerceClient::ManifestSummary
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ManifestSummary' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ManifestSummary.new
  end
  ...
  describe 'test an instance of ManifestSummary' do
    it 'should create an instance of ManifestSummary' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ManifestSummary)
    end
  end
