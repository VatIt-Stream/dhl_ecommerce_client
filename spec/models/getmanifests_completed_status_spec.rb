...
# Unit tests for DhlEcommerceClient::GetmanifestsCOMPLETEDStatus
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetmanifestsCOMPLETEDStatus' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::GetmanifestsCOMPLETEDStatus.new
  end
  ...
  describe 'test an instance of GetmanifestsCOMPLETEDStatus' do
    it 'should create an instance of GetmanifestsCOMPLETEDStatus' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::GetmanifestsCOMPLETEDStatus)
    end
  end
  ...
  describe 'test attribute "manifest_summary"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
