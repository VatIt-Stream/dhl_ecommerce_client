...
# Unit tests for DhlEcommerceClient::GetTransportationPickuprequestGoodresponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetTransportationPickuprequestGoodresponse' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::GetTransportationPickuprequestGoodresponse.new
  end
  ...
  describe 'test an instance of GetTransportationPickuprequestGoodresponse' do
    it 'should create an instance of GetTransportationPickuprequestGoodresponse' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::GetTransportationPickuprequestGoodresponse)
    end
  end
