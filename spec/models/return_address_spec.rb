...
# Unit tests for DhlEcommerceClient::ReturnAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReturnAddress' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ReturnAddress.new
  end
  ...
  describe 'test an instance of ReturnAddress' do
    it 'should create an instance of ReturnAddress' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ReturnAddress)
    end
  end
