...
# Unit tests for DhlEcommerceClient::DeleteTransportationPickuprequestBadResponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeleteTransportationPickuprequestBadResponse' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::DeleteTransportationPickuprequestBadResponse.new
  end
  ...
  describe 'test an instance of DeleteTransportationPickuprequestBadResponse' do
    it 'should create an instance of DeleteTransportationPickuprequestBadResponse' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::DeleteTransportationPickuprequestBadResponse)
    end
  end
