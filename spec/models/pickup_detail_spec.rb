...
# Unit tests for DhlEcommerceClient::PickupDetail
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PickupDetail' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::PickupDetail.new
  end
  ...
  describe 'test an instance of PickupDetail' do
    it 'should create an instance of PickupDetail' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::PickupDetail)
    end
  end
