...
# Unit tests for DhlEcommerceClient::Weight2
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Weight2' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::Weight2.new
  end
  ...
  describe 'test an instance of Weight2' do
    it 'should create an instance of Weight2' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::Weight2)
    end
  end
