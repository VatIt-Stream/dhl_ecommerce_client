...
# Unit tests for DhlEcommerceClient::ItemFee
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemFee' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ItemFee.new
  end
  ...
  describe 'test an instance of ItemFee' do
    it 'should create an instance of ItemFee' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ItemFee)
    end
  end
  ...
  describe 'test attribute "rule_info"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
