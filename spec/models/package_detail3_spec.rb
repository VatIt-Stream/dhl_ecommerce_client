...
# Unit tests for DhlEcommerceClient::PackageDetail3
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageDetail3' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::PackageDetail3.new
  end
  ...
  describe 'test an instance of PackageDetail3' do
    it 'should create an instance of PackageDetail3' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::PackageDetail3)
    end
  end
