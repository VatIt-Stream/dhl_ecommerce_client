...
# Unit tests for DhlEcommerceClient::TrackPackagesusingConsigneePostalCode
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackPackagesusingConsigneePostalCode' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::TrackPackagesusingConsigneePostalCode.new
  end
  ...
  describe 'test an instance of TrackPackagesusingConsigneePostalCode' do
    it 'should create an instance of TrackPackagesusingConsigneePostalCode' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::TrackPackagesusingConsigneePostalCode)
    end
  end
