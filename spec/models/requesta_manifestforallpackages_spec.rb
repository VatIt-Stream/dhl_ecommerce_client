...
# Unit tests for DhlEcommerceClient::RequestaManifestforallpackages
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestaManifestforallpackages' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::RequestaManifestforallpackages.new
  end
  ...
  describe 'test an instance of RequestaManifestforallpackages' do
    it 'should create an instance of RequestaManifestforallpackages' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::RequestaManifestforallpackages)
    end
  end
