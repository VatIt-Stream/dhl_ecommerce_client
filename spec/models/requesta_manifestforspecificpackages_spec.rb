...
# Unit tests for DhlEcommerceClient::RequestaManifestforspecificpackages
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestaManifestforspecificpackages' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::RequestaManifestforspecificpackages.new
  end
  ...
  describe 'test an instance of RequestaManifestforspecificpackages' do
    it 'should create an instance of RequestaManifestforspecificpackages' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::RequestaManifestforspecificpackages)
    end
  end
