...
# Unit tests for DhlEcommerceClient::TrackusingdhlPackageId
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackusingdhlPackageId' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::TrackusingdhlPackageId.new
  end
  ...
  describe 'test an instance of TrackusingdhlPackageId' do
    it 'should create an instance of TrackusingdhlPackageId' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::TrackusingdhlPackageId)
    end
  end
