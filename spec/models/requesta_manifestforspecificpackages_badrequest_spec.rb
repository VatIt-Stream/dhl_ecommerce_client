...
# Unit tests for DhlEcommerceClient::RequestaManifestforspecificpackagesBadrequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestaManifestforspecificpackagesBadrequest' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::RequestaManifestforspecificpackagesBadrequest.new
  end
  ...
  describe 'test an instance of RequestaManifestforspecificpackagesBadrequest' do
    it 'should create an instance of RequestaManifestforspecificpackagesBadrequest' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::RequestaManifestforspecificpackagesBadrequest)
    end
  end
  ...
  describe 'test attribute "invalid_params"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
