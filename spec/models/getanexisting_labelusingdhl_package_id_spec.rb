...
# Unit tests for DhlEcommerceClient::GetanexistingLabelusingdhlPackageId
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetanexistingLabelusingdhlPackageId' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::GetanexistingLabelusingdhlPackageId.new
  end
  ...
  describe 'test an instance of GetanexistingLabelusingdhlPackageId' do
    it 'should create an instance of GetanexistingLabelusingdhlPackageId' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::GetanexistingLabelusingdhlPackageId)
    end
  end
