...
# Unit tests for DhlEcommerceClient::ItemInsurance1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemInsurance1' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ItemInsurance1.new
  end
  ...
  describe 'test an instance of ItemInsurance1' do
    it 'should create an instance of ItemInsurance1' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ItemInsurance1)
    end
  end
