...
# Unit tests for DhlEcommerceClient::ReturnAddress3
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ReturnAddress3' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ReturnAddress3.new
  end
  ...
  describe 'test an instance of ReturnAddress3' do
    it 'should create an instance of ReturnAddress3' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ReturnAddress3)
    end
  end
