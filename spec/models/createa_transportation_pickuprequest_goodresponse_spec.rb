...
# Unit tests for DhlEcommerceClient::CreateaTransportationPickuprequestGoodresponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateaTransportationPickuprequestGoodresponse' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::CreateaTransportationPickuprequestGoodresponse.new
  end
  ...
  describe 'test an instance of CreateaTransportationPickuprequestGoodresponse' do
    it 'should create an instance of CreateaTransportationPickuprequestGoodresponse' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::CreateaTransportationPickuprequestGoodresponse)
    end
  end
  ...
  describe 'test attribute "weight_uom"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "ready_by"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "packaging_type"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "pickup_time_begin"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
  ...
  describe 'test attribute "pickup_time_end"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
