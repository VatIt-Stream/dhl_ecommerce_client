...
# Unit tests for DhlEcommerceClient::RequestManifestSforspecificpackagesRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestManifestSforspecificpackagesRequest' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::RequestManifestSforspecificpackagesRequest.new
  end
  ...
  describe 'test an instance of RequestManifestSforspecificpackagesRequest' do
    it 'should create an instance of RequestManifestSforspecificpackagesRequest' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::RequestManifestSforspecificpackagesRequest)
    end
  end
