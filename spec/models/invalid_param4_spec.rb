...
# Unit tests for DhlEcommerceClient::InvalidParam4
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvalidParam4' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::InvalidParam4.new
  end
  ...
  describe 'test an instance of InvalidParam4' do
    it 'should create an instance of InvalidParam4' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::InvalidParam4)
    end
  end
