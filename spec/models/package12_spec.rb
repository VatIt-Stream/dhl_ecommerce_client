...
# Unit tests for DhlEcommerceClient::Package12
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Package12' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::Package12.new
  end
  ...
  describe 'test an instance of Package12' do
    it 'should create an instance of Package12' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::Package12)
    end
  end
  ...
  describe 'test attribute "pickup_detail"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
