...
# Unit tests for DhlEcommerceClient::RequestQuoteresponse
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestQuoteresponse' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::RequestQuoteresponse.new
  end
  ...
  describe 'test an instance of RequestQuoteresponse' do
    it 'should create an instance of RequestQuoteresponse' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::RequestQuoteresponse)
    end
  end
