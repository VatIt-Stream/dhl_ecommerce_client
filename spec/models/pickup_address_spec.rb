...
# Unit tests for DhlEcommerceClient::PickupAddress
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PickupAddress' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::PickupAddress.new
  end
  ...
  describe 'test an instance of PickupAddress' do
    it 'should create an instance of PickupAddress' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::PickupAddress)
    end
  end
