...
# Unit tests for DhlEcommerceClient::RequestAccessTokenSuccessful
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestAccessTokenSuccessful' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::RequestAccessTokenSuccessful.new
  end
  ...
  describe 'test an instance of RequestAccessTokenSuccessful' do
    it 'should create an instance of RequestAccessTokenSuccessful' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::RequestAccessTokenSuccessful)
    end
  end
