...
# Unit tests for DhlEcommerceClient::TrackPackagesusingConsigneeCountry
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackPackagesusingConsigneeCountry' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::TrackPackagesusingConsigneeCountry.new
  end
  ...
  describe 'test an instance of TrackPackagesusingConsigneeCountry' do
    it 'should create an instance of TrackPackagesusingConsigneeCountry' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::TrackPackagesusingConsigneeCountry)
    end
  end
