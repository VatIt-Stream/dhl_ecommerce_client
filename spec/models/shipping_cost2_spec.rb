...
# Unit tests for DhlEcommerceClient::ShippingCost2
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShippingCost2' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ShippingCost2.new
  end
  ...
  describe 'test an instance of ShippingCost2' do
    it 'should create an instance of ShippingCost2' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ShippingCost2)
    end
  end
  ...
  describe 'test attribute "duties_paid"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
