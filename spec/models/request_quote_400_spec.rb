...
# Unit tests for DhlEcommerceClient::RequestQuote400
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestQuote400' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::RequestQuote400.new
  end
  ...
  describe 'test an instance of RequestQuote400' do
    it 'should create an instance of RequestQuote400' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::RequestQuote400)
    end
  end
