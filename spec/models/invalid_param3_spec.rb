...
# Unit tests for DhlEcommerceClient::InvalidParam3
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvalidParam3' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::InvalidParam3.new
  end
  ...
  describe 'test an instance of InvalidParam3' do
    it 'should create an instance of InvalidParam3' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::InvalidParam3)
    end
  end
