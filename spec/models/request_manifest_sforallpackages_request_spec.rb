...
# Unit tests for DhlEcommerceClient::RequestManifestSforallpackagesRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestManifestSforallpackagesRequest' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::RequestManifestSforallpackagesRequest.new
  end
  ...
  describe 'test an instance of RequestManifestSforallpackagesRequest' do
    it 'should create an instance of RequestManifestSforallpackagesRequest' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::RequestManifestSforallpackagesRequest)
    end
  end
