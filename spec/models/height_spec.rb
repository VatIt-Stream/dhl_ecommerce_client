...
# Unit tests for DhlEcommerceClient::Height
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Height' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::Height.new
  end
  ...
  describe 'test an instance of Height' do
    it 'should create an instance of Height' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::Height)
    end
  end
