...
# Unit tests for DhlEcommerceClient::InsuranceCharge1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InsuranceCharge1' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::InsuranceCharge1.new
  end
  ...
  describe 'test an instance of InsuranceCharge1' do
    it 'should create an instance of InsuranceCharge1' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::InsuranceCharge1)
    end
  end
