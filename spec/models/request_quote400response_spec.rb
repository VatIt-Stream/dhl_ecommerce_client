...
# Unit tests for DhlEcommerceClient::RequestQuote400response
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RequestQuote400response' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::RequestQuote400response.new
  end
  ...
  describe 'test an instance of RequestQuote400response' do
    it 'should create an instance of RequestQuote400response' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::RequestQuote400response)
    end
  end
