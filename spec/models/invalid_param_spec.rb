...
# Unit tests for DhlEcommerceClient::InvalidParam
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InvalidParam' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::InvalidParam.new
  end
  ...
  describe 'test an instance of InvalidParam' do
    it 'should create an instance of InvalidParam' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::InvalidParam)
    end
  end
