...
# Unit tests for DhlEcommerceClient::ItemFreight
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemFreight' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ItemFreight.new
  end
  ...
  describe 'test an instance of ItemFreight' do
    it 'should create an instance of ItemFreight' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ItemFreight)
    end
  end
