...
# Unit tests for DhlEcommerceClient::PickupAddress1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PickupAddress1' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::PickupAddress1.new
  end
  ...
  describe 'test an instance of PickupAddress1' do
    it 'should create an instance of PickupAddress1' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::PickupAddress1)
    end
  end
