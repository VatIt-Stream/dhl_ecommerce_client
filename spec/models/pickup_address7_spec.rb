...
# Unit tests for DhlEcommerceClient::PickupAddress7
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PickupAddress7' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::PickupAddress7.new
  end
  ...
  describe 'test an instance of PickupAddress7' do
    it 'should create an instance of PickupAddress7' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::PickupAddress7)
    end
  end
