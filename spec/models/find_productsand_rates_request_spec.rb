...
# Unit tests for DhlEcommerceClient::FindProductsandRatesRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FindProductsandRatesRequest' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::FindProductsandRatesRequest.new
  end
  ...
  describe 'test an instance of FindProductsandRatesRequest' do
    it 'should create an instance of FindProductsandRatesRequest' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::FindProductsandRatesRequest)
    end
  end
