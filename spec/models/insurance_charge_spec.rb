...
# Unit tests for DhlEcommerceClient::InsuranceCharge
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InsuranceCharge' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::InsuranceCharge.new
  end
  ...
  describe 'test an instance of InsuranceCharge' do
    it 'should create an instance of InsuranceCharge' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::InsuranceCharge)
    end
  end
