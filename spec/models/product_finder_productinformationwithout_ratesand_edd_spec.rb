...
# Unit tests for DhlEcommerceClient::ProductFinderProductinformationwithoutRatesandEDD
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductFinderProductinformationwithoutRatesandEDD' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ProductFinderProductinformationwithoutRatesandEDD.new
  end
  ...
  describe 'test an instance of ProductFinderProductinformationwithoutRatesandEDD' do
    it 'should create an instance of ProductFinderProductinformationwithoutRatesandEDD' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ProductFinderProductinformationwithoutRatesandEDD)
    end
  end
