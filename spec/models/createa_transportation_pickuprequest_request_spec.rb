...
# Unit tests for DhlEcommerceClient::CreateaTransportationPickuprequestRequest
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateaTransportationPickuprequestRequest' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::CreateaTransportationPickuprequestRequest.new
  end
  ...
  describe 'test an instance of CreateaTransportationPickuprequestRequest' do
    it 'should create an instance of CreateaTransportationPickuprequestRequest' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::CreateaTransportationPickuprequestRequest)
    end
  end
