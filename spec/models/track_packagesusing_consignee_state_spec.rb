...
# Unit tests for DhlEcommerceClient::TrackPackagesusingConsigneeState
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackPackagesusingConsigneeState' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::TrackPackagesusingConsigneeState.new
  end
  ...
  describe 'test an instance of TrackPackagesusingConsigneeState' do
    it 'should create an instance of TrackPackagesusingConsigneeState' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::TrackPackagesusingConsigneeState)
    end
  end
