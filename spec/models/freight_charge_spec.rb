...
# Unit tests for DhlEcommerceClient::FreightCharge
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FreightCharge' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::FreightCharge.new
  end
  ...
  describe 'test an instance of FreightCharge' do
    it 'should create an instance of FreightCharge' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::FreightCharge)
    end
  end
