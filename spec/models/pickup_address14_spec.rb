...
# Unit tests for DhlEcommerceClient::PickupAddress14
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PickupAddress14' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::PickupAddress14.new
  end
  ...
  describe 'test an instance of PickupAddress14' do
    it 'should create an instance of PickupAddress14' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::PickupAddress14)
    end
  end
