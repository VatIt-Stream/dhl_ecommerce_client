...
# Unit tests for DhlEcommerceClient::CustomsDetail2
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CustomsDetail2' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::CustomsDetail2.new
  end
  ...
  describe 'test an instance of CustomsDetail2' do
    it 'should create an instance of CustomsDetail2' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::CustomsDetail2)
    end
  end
