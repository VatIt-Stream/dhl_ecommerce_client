...
# Unit tests for DhlEcommerceClient::TrackusingtrackingId
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackusingtrackingId' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::TrackusingtrackingId.new
  end
  ...
  describe 'test an instance of TrackusingtrackingId' do
    it 'should create an instance of TrackusingtrackingId' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::TrackusingtrackingId)
    end
  end
