...
# Unit tests for DhlEcommerceClient::PickupAddress15
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PickupAddress15' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::PickupAddress15.new
  end
  ...
  describe 'test an instance of PickupAddress15' do
    it 'should create an instance of PickupAddress15' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::PickupAddress15)
    end
  end
