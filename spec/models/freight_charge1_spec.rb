...
# Unit tests for DhlEcommerceClient::FreightCharge1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FreightCharge1' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::FreightCharge1.new
  end
  ...
  describe 'test an instance of FreightCharge1' do
    it 'should create an instance of FreightCharge1' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::FreightCharge1)
    end
  end
