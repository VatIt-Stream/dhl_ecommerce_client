...
# Unit tests for DhlEcommerceClient::FeeTotal
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'FeeTotal' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::FeeTotal.new
  end
  ...
  describe 'test an instance of FeeTotal' do
    it 'should create an instance of FeeTotal' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::FeeTotal)
    end
  end
