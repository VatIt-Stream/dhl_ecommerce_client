...
# Unit tests for DhlEcommerceClient::PackageDetail2
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageDetail2' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::PackageDetail2.new
  end
  ...
  describe 'test an instance of PackageDetail2' do
    it 'should create an instance of PackageDetail2' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::PackageDetail2)
    end
  end
  ...
  describe 'test attribute "billing_reference1"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  describe 'test attribute "billing_reference2"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
