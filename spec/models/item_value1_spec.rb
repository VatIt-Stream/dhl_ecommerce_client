...
# Unit tests for DhlEcommerceClient::ItemValue1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemValue1' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ItemValue1.new
  end
  ...
  describe 'test an instance of ItemValue1' do
    it 'should create an instance of ItemValue1' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ItemValue1)
    end
  end
