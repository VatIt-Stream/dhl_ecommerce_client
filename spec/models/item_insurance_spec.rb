...
# Unit tests for DhlEcommerceClient::ItemInsurance
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ItemInsurance' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ItemInsurance.new
  end
  ...
  describe 'test an instance of ItemInsurance' do
    it 'should create an instance of ItemInsurance' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ItemInsurance)
    end
  end
