...
# Unit tests for DhlEcommerceClient::PackageDetails
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PackageDetails' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::PackageDetails.new
  end
  ...
  describe 'test an instance of PackageDetails' do
    it 'should create an instance of PackageDetails' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::PackageDetails)
    end
  end
