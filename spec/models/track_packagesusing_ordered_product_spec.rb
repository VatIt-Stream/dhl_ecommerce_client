...
# Unit tests for DhlEcommerceClient::TrackPackagesusingOrderedProduct
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackPackagesusingOrderedProduct' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::TrackPackagesusingOrderedProduct.new
  end
  ...
  describe 'test an instance of TrackPackagesusingOrderedProduct' do
    it 'should create an instance of TrackPackagesusingOrderedProduct' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::TrackPackagesusingOrderedProduct)
    end
  end
