...
# Unit tests for DhlEcommerceClient::Weight17
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Weight17' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::Weight17.new
  end
  ...
  describe 'test an instance of Weight17' do
    it 'should create an instance of Weight17' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::Weight17)
    end
  end
