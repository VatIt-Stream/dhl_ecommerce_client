...
# Unit tests for DhlEcommerceClient::ShippingCost
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ShippingCost' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ShippingCost.new
  end
  ...
  describe 'test an instance of ShippingCost' do
    it 'should create an instance of ShippingCost' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ShippingCost)
    end
  end
