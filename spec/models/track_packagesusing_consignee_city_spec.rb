...
# Unit tests for DhlEcommerceClient::TrackPackagesusingConsigneeCity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackPackagesusingConsigneeCity' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::TrackPackagesusingConsigneeCity.new
  end
  ...
  describe 'test an instance of TrackPackagesusingConsigneeCity' do
    it 'should create an instance of TrackPackagesusingConsigneeCity' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::TrackPackagesusingConsigneeCity)
    end
  end
