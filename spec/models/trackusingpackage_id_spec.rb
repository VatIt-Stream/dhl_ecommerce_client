...
# Unit tests for DhlEcommerceClient::TrackusingpackageId
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackusingpackageId' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::TrackusingpackageId.new
  end
  ...
  describe 'test an instance of TrackusingpackageId' do
    it 'should create an instance of TrackusingpackageId' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::TrackusingpackageId)
    end
  end
