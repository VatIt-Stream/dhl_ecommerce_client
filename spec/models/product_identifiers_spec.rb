...
# Unit tests for DhlEcommerceClient::ProductIdentifiers
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductIdentifiers' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ProductIdentifiers.new
  end
  ...
  describe 'test an instance of ProductIdentifiers' do
    it 'should create an instance of ProductIdentifiers' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ProductIdentifiers)
    end
  end
  ...
  describe 'test attribute "jan"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
