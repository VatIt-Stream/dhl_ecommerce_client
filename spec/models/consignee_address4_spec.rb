...
# Unit tests for DhlEcommerceClient::ConsigneeAddress4
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ConsigneeAddress4' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ConsigneeAddress4.new
  end
  ...
  describe 'test an instance of ConsigneeAddress4' do
    it 'should create an instance of ConsigneeAddress4' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ConsigneeAddress4)
    end
  end
