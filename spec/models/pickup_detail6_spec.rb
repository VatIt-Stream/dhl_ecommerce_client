...
# Unit tests for DhlEcommerceClient::PickupDetail6
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PickupDetail6' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::PickupDetail6.new
  end
  ...
  describe 'test an instance of PickupDetail6' do
    it 'should create an instance of PickupDetail6' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::PickupDetail6)
    end
  end
  describe 'test attribute "sold_to"' do
    it 'should work' do
