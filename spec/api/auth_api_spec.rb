...
# Unit tests for DhlEcommerceClient::AuthApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'AuthApi' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::AuthApi.new
  end
  ...
  describe 'test an instance of AuthApi' do
    it 'should create an instance of AuthApi' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::AuthApi)
    end
  end

  # unit tests for request_access_token
  ...
  describe 'request_access_token test' do
    it 'should work' do
