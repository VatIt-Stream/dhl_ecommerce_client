...
# Unit tests for DhlEcommerceClient::TrackASinglePackageApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'TrackASinglePackageApi' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::TrackASinglePackageApi.new
  end
  ...
  describe 'test an instance of TrackASinglePackageApi' do
    it 'should create an instance of TrackASinglePackageApi' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::TrackASinglePackageApi)
    end
  end

  # unit tests for trackusingpackage_id
  ...
  describe 'trackusingpackage_id test' do
    it 'should work' do
