...
# Unit tests for DhlEcommerceClient::ProductFinderApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProductFinderApi' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::ProductFinderApi.new
  end
  ...
  describe 'test an instance of ProductFinderApi' do
    it 'should create an instance of ProductFinderApi' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::ProductFinderApi)
    end
  end

  # unit tests for find_productsand_rates
  ...
  describe 'find_productsand_rates test' do
    it 'should work' do
