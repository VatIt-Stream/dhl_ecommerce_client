...
# Unit tests for DhlEcommerceClient::CreateManifestSApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CreateManifestSApi' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::CreateManifestSApi.new
  end
  ...
  describe 'test an instance of CreateManifestSApi' do
    it 'should create an instance of CreateManifestSApi' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::CreateManifestSApi)
    end
  end

  # unit tests for request_manifest_sforspecificpackages
  ...
  describe 'request_manifest_sforspecificpackages test' do
    it 'should work' do
