...
# Unit tests for DhlEcommerceClient::DutyTaxCalculatorApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DutyTaxCalculatorApi' do
  before do
    # run before each test
    @instance = DhlEcommerceClient::DutyTaxCalculatorApi.new
  end
  ...
  describe 'test an instance of DutyTaxCalculatorApi' do
    it 'should create an instance of DutyTaxCalculatorApi' do
      expect(@instance).to be_instance_of(DhlEcommerceClient::DutyTaxCalculatorApi)
    end
  end

  # unit tests for request_quote
  # Request Quote
  # 200
  # @param content_type
  # @param body
  ...
  describe 'request_quote test' do
    it 'should work' do
