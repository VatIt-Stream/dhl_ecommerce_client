...
module DhlEcommerceClient
  class ItemFee
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'ruleInfo')
        self.rule_info = attributes[:'ruleInfo']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @rule_info.nil?
        invalid_properties.push('invalid value for "rule_info", rule_info cannot be nil.')
      end
    ...
    def hash
      [name, currency, value, rule_info].hash
    end
