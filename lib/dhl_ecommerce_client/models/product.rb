...
module DhlEcommerceClient
  class Product
    ...
    attr_accessor :tracking_available
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'trackingAvailable')
        self.tracking_available = attributes[:'trackingAvailable']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @tracking_available.nil?
        invalid_properties.push('invalid value for "tracking_available", tracking_available cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @tracking_available.nil?
      true
    end
    ...
    def hash
      [ordered_product_id, product_name, description, tracking_available].hash
    end
