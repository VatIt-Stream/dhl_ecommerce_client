...
module DhlEcommerceClient
  class CreateInternationalLabelRequest
    ...
    def self.swagger_types
      {
        ...
        :'consignee_address' => :'ConsigneeAddress3',
        :'return_address' => :'ReturnAddress3',
        :'pickup_address' => :'PickupAddress',
        :'shipper_address' => :'ShipperAddress',
        :'package_detail' => :'PackageDetail3',
        :'customs_details' => :'Array<CustomsDetail>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'shipperAddress')
        self.shipper_address = attributes[:'shipperAddress']
      end
    ...
    def list_invalid_properties
      ...
      if @shipper_address.nil?
        invalid_properties.push('invalid value for "shipper_address", shipper_address cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @shipper_address.nil?
    ...
    def hash
      [pickup, distribution_center, ordered_product_id, consignee_address, return_address, pickup_address, shipper_address, package_detail, customs_details].hash
    end
