...
module DhlEcommerceClient
  class PackageDetail3
    ...
    attr_accessor :billing_reference1

    attr_accessor :billing_reference2
    ...
    def self.attribute_map
      {
        ...
        :'billing_reference1' => :'billingReference1',
        :'billing_reference2' => :'billingReference2',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'packageDescription')
        self.package_description = attributes[:'packageDescription']
      end
      ...
      if attributes.has_key?(:'billingReference1')
        self.billing_reference1 = attributes[:'billingReference1']
      end

      if attributes.has_key?(:'billingReference2')
        self.billing_reference2 = attributes[:'billingReference2']
      end

      if attributes.has_key?(:'contentCategory')
        self.content_category = attributes[:'contentCategory']
      end
    ...
    def list_invalid_properties
      ...
      if @billing_reference1.nil?
        invalid_properties.push('invalid value for "billing_reference1", billing_reference1 cannot be nil.')
      end

      if @billing_reference2.nil?
        invalid_properties.push('invalid value for "billing_reference2", billing_reference2 cannot be nil.')
      end

      if @content_category.nil?
        invalid_properties.push('invalid value for "content_category", content_category cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @billing_reference1.nil?
      return false if @billing_reference2.nil?
      return false if @content_category.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          billing_reference1 == o.billing_reference1 &&
          billing_reference2 == o.billing_reference2 &&
    ...
    def hash
      [package_id, package_description, weight, service, service_endorsement, billing_reference1, billing_reference2, content_category, shipping_cost].hash
    end
