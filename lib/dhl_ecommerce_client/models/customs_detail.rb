...
module DhlEcommerceClient
  class CustomsDetail
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'packagedQuantity')
        self.packaged_quantity = attributes[:'packagedQuantity']
      end
    ...
    def list_invalid_properties
      ...
      if @packaged_quantity.nil?
        invalid_properties.push('invalid value for "packaged_quantity", packaged_quantity cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @packaged_quantity.nil?
    ...
    def hash
      [item_description, country_of_origin, hs_code, packaged_quantity, sku_number, item_value, currency].hash
    end
