...
module DhlEcommerceClient
  class RequestQuote200
    ...
    def self.swagger_types
      {
        ...
        :'consignee_address' => :'ConsigneeAddress4',
        :'package_details' => :'PackageDetails1',
        :'customs_details' => :'Array<CustomsDetail2>',
        :'sender_address' => :'SenderAddress'
      }
    end
    ...
    def hash
      [quote_id, pickup_account, item_seller, pricing_strategy, fee_totals, consignee_address, package_details, customs_details, sender_address].hash
    end
