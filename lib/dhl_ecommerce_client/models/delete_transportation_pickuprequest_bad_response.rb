...
module DhlEcommerceClient
  class DeleteTransportationPickuprequestBadResponse
    attr_accessor :type
    ...
    def self.swagger_types
      {
        :'type' => :'String',
        :'title' => :'String',
        :'invalid_params' => :'Array<InvalidParam4>'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'invalidParams')
        if (value = attributes[:'invalidParams']).is_a?(Array)
    ...
    def list_invalid_properties
      ...
      if @invalid_params.nil?
        invalid_properties.push('invalid value for "invalid_params", invalid_params cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @invalid_params.nil?
      true
    end
    ...
    def hash
      [type, title, invalid_params].hash
    end
