...
module DhlEcommerceClient
  class ProductIdentifiers
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'jan')
        self.jan = attributes[:'jan']
      end
    ...
    def list_invalid_properties
      ...
      if @upc.nil?
        invalid_properties.push('invalid value for "upc", upc cannot be nil.')
      end

      if @ean.nil?
        invalid_properties.push('invalid value for "ean", ean cannot be nil.')
      end

      if @jan.nil?
        invalid_properties.push('invalid value for "jan", jan cannot be nil.')
      end

      if @isbn.nil?
        invalid_properties.push('invalid value for "isbn", isbn cannot be nil.')
      end

      if @mpn.nil?
        invalid_properties.push('invalid value for "mpn", mpn cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ean.nil?
      return false if @jan.nil?
      return false if @isbn.nil?
      return false if @mpn.nil?
    ...
    def hash
      [upc, ean, jan, isbn, mpn, brand].hash
    end
