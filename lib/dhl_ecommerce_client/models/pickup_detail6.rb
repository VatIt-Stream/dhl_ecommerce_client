...
module DhlEcommerceClient
  class PickupDetail6
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'soldTo')
        self.sold_to = attributes[:'soldTo']
      end
    ...
    def list_invalid_properties
      ...
      if @sold_to.nil?
        invalid_properties.push('invalid value for "sold_to", sold_to cannot be nil.')
      end
    ...
    def hash
      [sold_to, pickup, pickup_address].hash
    end
