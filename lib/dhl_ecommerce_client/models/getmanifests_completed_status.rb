...
module DhlEcommerceClient
  class GetmanifestsCOMPLETEDStatus
    ...
    attr_accessor :manifest_summary
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'manifestSummary')
        self.manifest_summary = attributes[:'manifestSummary']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @manifest_summary.nil?
        invalid_properties.push('invalid value for "manifest_summary", manifest_summary cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @manifest_summary.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          manifest_summary == o.manifest_summary
    end
    ...
    def hash
      [timestamp, pickup, request_id, status, link, manifests, manifest_summary].hash
    end
