  ...
  class Label1
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'labelData')
        self.label_data = attributes[:'labelData']
      end
      ...
      if attributes.has_key?(:'labelDetail')
        self.label_detail = attributes[:'labelDetail']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @label_detail.nil?
        invalid_properties.push('invalid value for "label_detail", label_detail cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @label_detail.nil?
      true
    end
    ...
    def hash
      [created_on, package_id, dhl_package_id, label_data, encode_type, format, link, label_detail].hash
    end
