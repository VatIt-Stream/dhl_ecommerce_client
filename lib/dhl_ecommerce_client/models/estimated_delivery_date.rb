...
module DhlEcommerceClient
  class EstimatedDeliveryDate
    ...
    attr_accessor :expected_transit
    ...
    def self.attribute_map
      {
        ...
        :'expected_transit' => :'expectedTransit'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'calculate')
        self.calculate = attributes[:'calculate']
      end

      if attributes.has_key?(:'deliveryBy')
        self.delivery_by = attributes[:'deliveryBy']
      end
      ...
      if attributes.has_key?(:'expectedTransit')
        self.expected_transit = attributes[:'expectedTransit']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @calculate.nil?
        invalid_properties.push('invalid value for "calculate", calculate cannot be nil.')
      end

      if @delivery_by.nil?
        invalid_properties.push('invalid value for "delivery_by", delivery_by cannot be nil.')
      end

      if @expected_ship_date.nil?
        invalid_properties.push('invalid value for "expected_ship_date", expected_ship_date cannot be nil.')
      end

      if @expected_transit.nil?
        invalid_properties.push('invalid value for "expected_transit", expected_transit cannot be nil.')
      end
    ...
    def valid?
      return false if @calculate.nil?
      return false if @delivery_by.nil?
      return false if @expected_ship_date.nil?
      return false if @expected_transit.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          expected_transit == o.expected_transit
    end
    ...
    def hash
      [calculate, delivery_by, expected_ship_date, expected_transit].hash
    end
