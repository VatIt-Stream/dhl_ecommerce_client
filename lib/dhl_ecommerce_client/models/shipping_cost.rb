...
module DhlEcommerceClient
  class ShippingCost
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'dutiesPaid')
        self.duties_paid = attributes[:'dutiesPaid']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @duties_paid.nil?
        invalid_properties.push('invalid value for "duties_paid", duties_paid cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @duties_paid.nil?
      true
    end
    ...
    def hash
      [currency, freight, declared_value, insured_value, duties_paid].hash
    end
