...
module DhlEcommerceClient
  class Package12
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'pickupDetail')
        self.pickup_detail = attributes[:'pickupDetail']
      end
    ...
    def list_invalid_properties
      ...
      if @pickup_detail.nil?
        invalid_properties.push('invalid value for "pickup_detail", pickup_detail cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @pickup_detail.nil?
    ...
    def hash
      [recipient, events, pickup_detail, package].hash
    end
