...
module DhlEcommerceClient
  class CreateaTransportationPickuprequestRequest
    ...
    def self.swagger_types
      {
        ...
        :'pickup_address' => :'PickupAddress14'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'shipmentCount')
        self.shipment_count = attributes[:'shipmentCount']
      end
    ...
    def hash
      [pickup_account, merchant_id, packaging_type, value, currency, shipment_weight, weight_uom, shipment_count, container_count, package_count, ready_by, special_instructions, pickup_address].hash
    end
