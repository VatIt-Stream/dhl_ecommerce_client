...
module DhlEcommerceClient
  class CustomsDetail1
    attr_accessor :item_id

    attr_accessor :hs_code

    attr_accessor :hs_code_applied
    ...
    def self.swagger_types
      {
        ...
        :'item_quantity' => :'ItemQuantity',
        :'item_value' => :'ItemValue1',
        :'item_freight' => :'ItemFreight1',
        :'item_insurance' => :'ItemInsurance1',
        :'width' => :'Width',
        :'length' => :'Length',
        :'height' => :'Height',
        :'weight' => :'Weight',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'hsCodeApplied')
        self.hs_code_applied = attributes[:'hsCodeApplied']
      end
      ...
      if attributes.has_key?(:'itemFees')
        if (value = attributes[:'itemFees']).is_a?(Array)
          self.item_fees = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if @hs_code_applied.nil?
        invalid_properties.push('invalid value for "hs_code_applied", hs_code_applied cannot be nil.')
      end
      ...
      if @item_fees.nil?
        invalid_properties.push('invalid value for "item_fees", item_fees cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @hs_code_applied.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          item_id == o.item_id &&
          hs_code == o.hs_code &&
          hs_code_applied == o.hs_code_applied &&
    ...
    def hash
      [item_id, hs_code, hs_code_applied, sku_number, product_identifiers, product_category, item_short_description, item_description, size, gender, age_group, color, style, composition, condition, country_of_origin, qualifies_for_preferential_tariffs, item_quantity, item_value, item_freight, item_insurance, width, length, height, weight, volume, area, item_fees].hash
    end
