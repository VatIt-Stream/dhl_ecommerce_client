...
module DhlEcommerceClient
  class CustomsDetail1
    ...
    def hash
      [item_id, hs_code, sku_number, product_category, item_short_description, item_description, size, gender, age_group, color, style, condition, qualifies_for_preferential_tariffs, country_of_origin, composition, item_quantity, item_value, product_identifiers, item_freight, item_insurance, length, width, height, weight, area, volume].hash
    end
