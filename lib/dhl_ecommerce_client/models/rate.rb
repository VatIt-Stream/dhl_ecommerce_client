...
module DhlEcommerceClient
  class Rate
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'rateDate')
        self.rate_date = attributes[:'rateDate']
      end
    ...
    def list_invalid_properties
      ...
      if @rate_date.nil?
        invalid_properties.push('invalid value for "rate_date", rate_date cannot be nil.')
      end
    ...
    def hash
      [calculate, currency, rate_date, max_price].hash
    end
