...
module DhlEcommerceClient
  class LabelApi
    ...
    def create_domestic_label(format, content_type, body, opts = {})
      data, _status_code, _headers = create_domestic_label_with_http_info(format, content_type, body, opts)
      data
    end
    ...
    # @return [Array<(CreateDomesticLabel28Format3APNG29, Fixnum, Hash)>] CreateDomesticLabel28Format3APNG29 data, response status code and response headers
    def create_domestic_label_with_http_info(format, content_type, body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LabelApi.create_domestic_label ...'
      end
      # verify the required parameter 'format' is set
      if @api_client.config.client_side_validation && format.nil?
        fail ArgumentError, "Missing the required parameter 'format' when calling LabelApi.create_domestic_label"
      end
      # verify the required parameter 'content_type' is set
      if @api_client.config.client_side_validation && content_type.nil?
        fail ArgumentError, "Missing the required parameter 'content_type' when calling LabelApi.create_domestic_label"
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling LabelApi.create_domestic_label"
      end
      # resource path
      local_var_path = '/shipping/v4/label'
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path,
        ...
        :return_type => 'CreateDomesticLabel28Format3APNG29')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LabelApi#create_domestic_label\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def getanexisting_label(package_id, opts = {})
      data, _status_code, _headers = getanexisting_label_with_http_info(package_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :authorization
    # @return [Array<(GetanexistingLabelusingdhlPackageId, Fixnum, Hash)>] GetanexistingLabelusingdhlPackageId data, response status code and response headers
    def getanexisting_label_with_http_info(package_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: LabelApi.getanexisting_label ...'
      end
      # verify the required parameter 'package_id' is set
      if @api_client.config.client_side_validation && package_id.nil?
        fail ArgumentError, "Missing the required parameter 'package_id' when calling LabelApi.getanexisting_label"
      end
      # resource path
      local_var_path = '/shipping/v4/label/5351244'
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path,
        ...
        :body => post_body,
        :auth_names => auth_names,
        :return_type => 'GetanexistingLabelusingdhlPackageId')
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: LabelApi#getanexisting_label\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
